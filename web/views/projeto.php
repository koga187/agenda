...
$queryProjeto = 'SELECT * FROM projeto';

$resProjeto = $pdo->query($queryProjeto);

$arrayProjeto = array();

$resProjeto->fetch(function($projeto) {
    $arrayProjeto[] = $projeto['nome'];
});
...
<head>
    ...
    <script src='../libs/fullcalendar/fullcalendar.js' type="application/javascript"></script>
    <link href='js/fullcalendar/scheduler.css' rel='stylesheet' />
...
<table class="table table-bordered">
    ...
    <tr style="height: 100vh">
        <?php foreach($arrayCabecalho as $cabecalho):?>
            <td class="<?php echo $cabecalho ?>"><div id="calendar"></div></td>
        <?php endforeach;?>
    </tr>
    </tbody>
    <tfoot>
